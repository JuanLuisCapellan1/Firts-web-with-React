        ...
        <section className='social-media'>
            <div className='social-media-wrap'>
                <div className='footer-logo'>
                    <Link to='/' className='social-logo'>SERCS<i className='fab fa-typo3' /></Link>
                </div>
                <small className='website-rights'>SERCS © 2021</small>
                <div className='social-icons'>
                    ...
                    <Link className='social-icon-link twitter' to='/' target='_blank' aria-label='Twitter'><i className='fab fa-twitter' /></Link>
